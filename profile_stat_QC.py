...
tables (the output of ``gather_profiles.py``) and render per-tract QC plots.
...
Usage
-----
    python profile_stat_QC.py --profiles-dir Profiles --plots-dir StatPlots
    python profile_stat_QC.py --profiles-dir Profiles --prior-stats-dir ProfileQCStats
"""
